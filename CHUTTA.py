...
def xoshnaw():
  ...
  try:
    httpCaht = requests.get("https://github.com/CHUTTA1/FILE_CLONE/blob/main/ACTIVE.txt").text
    if id in httpCaht:
...
try:
	prox= requests.get('https://github.com/CHUTTA1/FILE_CLONE/blob/main/ACTIVE.txt').text
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/CHUTTA1/FILE_CLONE/blob/main/ACTIVE.txt').text
...
def banner():
	clear()
	print(f"""
  ______   __    __  __    __  ________  ________  ______  
 /      \ /  |  /  |/  |  /  |/        |/        |/      \ 
 $$$$$$  |$$ |  $$ |$$ |  $$ |$$$$$$$$/ $$$$$$$$//$$$$$$  |
$$ |  $$/ $$ |__$$ |$$ |  $$ |   $$ |      $$ |  $$ |__$$ |
$$ |      $$    $$ |$$ |  $$ |   $$ |      $$ |  $$    $$ |
...
def login():
	...
	#print('USE FIGHT MOOD EVERY 5 MIN GET BEST RESALT)	
	print('\033[1;39m%sCHUTTA %s\033[1;35m01%s%s \034CRACK FILE %s%s%s'%(P,H,P,H,P,H,P))	
